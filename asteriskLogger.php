            ...
            if ($buffer == "\r\n") { // handle partial packets
                    ...
                    ($e['Event'] == 'Join' && !empty($e['Queue'])))
                {
                    ...
                    if ((preg_match($asteriskMatchInternal, $eChannel) && preg_match($asteriskMatchInternal, $eDestination)) ||
						...
						logLine(" FirstLog_Ettienne1: $asteriskMatchInternal\n");
						logLine(" FirstLog_Ettienne2: $eChannel\n");
						logLine(" FirstLog_Ettienne3: $eDestination\n");
...
// This matches the standard cases such as SIP/### or IAX/### Ettienne
